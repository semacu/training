...
- Link to the materials: https://tinyurl.com/2018-Rintro-Wolfson
...
x <- c(a, b, b, c, c, d) # othewise R thinks they are objects
```
...
```{r eval=FALSE}
x <- c("a", "b", "b", "c", "c", "d")
x == "b" # this is known as a logical or boolean vector, which is made up of TRUE or FALSE values only
x != "b"
