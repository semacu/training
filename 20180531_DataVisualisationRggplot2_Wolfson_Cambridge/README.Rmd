...
(a) Any differences of BMI between Smokers and Non-Smokers? (hint: try `boxplot`)
(b) Visualise the relationship between the Height and Weight of the patients
(c) A small trick: if you attach the data.frame `patient_data` as follows, then you will only need the column name without the '$' notation:
...
geom_point()
ggsave("/Users/martin03/Desktop/DataVisR/BMIvsWeight_ggplot2.pdf")
```
